...
import businessIcon from '../../assets/icons/briefcase.svg?url';
import creativityIcon from '../../assets/icons/palette.svg?url';
import languageIcon from '../../assets/icons/global.svg?url';
import educationIcon from '../../assets/icons/book.svg?url';
import houseIcon from '../../assets/icons/home.svg?url';
import lifestyleIcon from '../../assets/icons/lifestyle.svg?url';
    ...
    <div className={style['mega-menu']}>
      <div className={style['menu-section']}>
        ...
        <div className={style['menu-section_items']}>
          ...
          <button className={style['menu-section_item']} type="button">
            Управление командой
          </button>
          <button className={style['menu-section_item']} type="button">
            Маркетинг и реклама
      ...
      <div className={style['menu-section']}>
        ...
        <div className={style['menu-section_items']}>
          <h3 className={style['menu-section_title']}>
